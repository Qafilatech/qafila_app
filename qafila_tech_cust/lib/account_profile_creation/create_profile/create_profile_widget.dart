          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '6gmppp9v' /* Adjust the content below to ge... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .labelLarge
                                  .override(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Align(
                                  ...
                                  child: Stack(
                                    children: [
                                      if (_model.uploadedFileUrl_uploadData8ss2 ==
                                              '')
                                        Padding(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: CachedNetworkImage(
                                            ...
                                            fadeOutDuration:
                                                Duration(milliseconds: 200),
                                            imageUrl: _model
                                                .uploadedFileUrl_uploadData8ss2,
                                            width: 300.0,
                                            height: 300.0,
                                            fit: BoxFit.cover,
                                          ),
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (selectedMedia != null &&
                                    ...
                                    safeSetState(() => _model
                                        .isDataUploading_uploadData8ss2 = true);
                                    ...
                                    try {
                                      ...
                                      ScaffoldMessenger.of(context)
                                          .hideCurrentSnackBar();
                                      _model.isDataUploading_uploadData8ss2 =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        ...
                                        downloadUrls.length ==
                                            selectedMedia.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFile_uploadData8ss2 =
                                            selectedUploadedFiles.first;
                                        _model.uploadedFileUrl_uploadData8ss2 =
                                            downloadUrls.first;
                                      });
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: FFLocalizations.of(context).getText(
                                  'fia6j3zq' /* Your display name here... */,
                                ),
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: FFLocalizations.of(context).getText(
                                  'yu6ct0lq' /* Your email address here... */,
                                ),
                                hintStyle: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed(
                                    TermsScreenCopyWidget.routeName,
                                    queryParameters: {
                ...
                Text(
                  FFLocalizations.of(context).getText(
                    'kwgov10i' /* An App Developed by QafilaTech... */,
                  ),
