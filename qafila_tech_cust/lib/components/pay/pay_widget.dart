                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '0qzcyb4c' /* Fill in the information below ... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                ...
                child: Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon:
                          _model.cardNumberTextController!.text.isNotEmpty
                              ? InkWell(
                                  onTap: () async {
                                    _model.cardNumberTextController?.clear();
                                    safeSetState(() {});
                                  },
                                  child: Icon(
                                    Icons.clear,
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              contentPadding: EdgeInsets.all(16.0),
                              suffixIcon: _model
                                      .dateFieldTextController!.text.isNotEmpty
                                  ? InkWell(
                                      onTap: () async {
                                        _model.dateFieldTextController?.clear();
                                        safeSetState(() {});
                                      },
                                      child: Icon(
                                        Icons.clear,
                            ...
                            validator: _model.dateFieldTextControllerValidator
                                .asValidator(context),
                            inputFormatters: [_model.dateFieldMask],
                          ),
                        ),
                      ),
                    ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            cursorColor:
                                FlutterFlowTheme.of(context).primaryText,
                            validator: _model.pinFieldTextControllerValidator
                                .asValidator(context),
