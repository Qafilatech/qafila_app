import '/components/report_components/app_issue_menu/app_issue_menu_widget.dart';
import '/components/report_components/delivery_issue_menu/delivery_issue_menu_widget.dart';
...
class ReportIssueMenuWidget extends StatefulWidget {
  const ReportIssueMenuWidget({super.key});

  @override
  State<ReportIssueMenuWidget> createState() => _ReportIssueMenuWidgetState();
}

class _ReportIssueMenuWidgetState extends State<ReportIssueMenuWidget>
    with TickerProviderStateMixin {
  late ReportIssueMenuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportIssueMenuModel());
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'w2csvhen' /* 2. App or User Experience Issu... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                    .override(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'be8qyb9u' /* 3. Driver/Delivery Person Issu... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                    .override(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  '3vlgquil' /* 4. Order/Delivery Tracking Iss... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                    .override(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'u3ftph02' /* 5. Refund or Compensation Requ... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                    .override(
