...
const kTransitionInfoKey = '__transition_info__that_bottom_bar_y134zt';
...
void initializeRoutes({
  ...
  String? page3WidgetName,
  String? page3WidgetPath,
}) {
  ...
  Page3Widget.maybeSetRouteName(page3WidgetName);
  Page3Widget.maybeSetRoutePath(page3WidgetPath);
}
