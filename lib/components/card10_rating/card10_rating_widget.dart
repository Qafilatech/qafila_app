    ...
    return Padding(
      ...
      child: StreamBuilder<OrdersRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final card10RatingOrdersRecord = snapshot.data!;
            ...
            child: Padding(
              ...
              child: StreamBuilder<UsersRecord>(
                stream: UsersRecord.getDocument(
                    card10RatingOrdersRecord.assignedDriverId!),
                builder: (context, snapshot) {
                  // Customize what your widget looks like when it's loading.
                  if (!snapshot.hasData) {
                    return Center(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              valueOrDefault<String>(
                                                'Accepted: ${valueOrDefault<String>(
                                                  dateTimeFormat(
                                                    "relative",
                                                    card10RatingOrdersRecord
                                                        .acceptedOn,
                                ...
                                onTap: () async {
                                  ...
                                  if (isiOS) {
                                    await launchUrl(Uri.parse(
                                        "sms:${columnUsersRecord.phoneNumber}&body=${Uri.encodeComponent('Hello, SMS Test')}"));
                                  } else {
                                    await launchUrl(Uri(
                                      scheme: 'sms',
                                      path: columnUsersRecord.phoneNumber,
