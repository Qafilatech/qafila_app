...
import 'other_options_model.dart';
export 'other_options_model.dart';
...
class _OtherOptionsWidgetState extends State<OtherOptionsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OtherOptionsModel());
  }
    ...
    return Padding(
      ...
      child: StreamBuilder<OrdersRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final dropdown1OptionsOrdersRecord = snapshot.data!;
                            ...
                            return Dialog(
                              ...
                              child: Container(
                                ...
                                child: IssueWithOrderSelectWidget(
                                  ...
                                  categoryTitle: 'Report Issue With Order',
                                  desc:
                                      'Please enter the details of your issue with the order.',
                                  specificOrder: true,
                                  orderID: dropdown1OptionsOrdersRecord.orderId,
                                ),
                              ),
                            );
                          },
