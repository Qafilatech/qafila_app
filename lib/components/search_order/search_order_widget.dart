                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => OrderSummaryWidget(
                              rideRef: listViewRideRecord.reference,
                            ),
                          ),
                        );
                      },
                                    ...
                                    RichText(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          ...
                                          TextSpan(
                                            text: listViewRideRecord.orderID,
                                            style: TextStyle(
                                              color:
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    12.0, 0.0, 12.0, 0.0),
                                            child: Text(
                                              listViewRideRecord.orderStatus,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
