...
double priceCalcu(
  ...
  if (assist > 0) {
    basePrice += 0.04 * assist * distance;
  }
  ...
  switch (truckType) {
    ...
    case 'wheeler':
      ...
      break;
    case 'refrigerated':
      basePrice += (0.18 + gasPrice) * distance;
      break;
    case 'tanker':
      basePrice += (0.20 + gasPrice) * distance;
      break;
    case 'car carrier':
      basePrice += (0.22 + gasPrice) * distance;
      break;
    case 'dump':
      basePrice += (0.24 + gasPrice) * distance;
      break;
    case 'livestock':
      basePrice += (0.26 + gasPrice) * distance;
      break;
    default:
      basePrice += (0.08 + gasPrice) *
          distance; // Default to van pricing if truck type is unknown
  }
