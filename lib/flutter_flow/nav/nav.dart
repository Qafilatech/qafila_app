      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: SmallDeliveryScreenWidget.routeName,
              path: SmallDeliveryScreenWidget.routePath,
              builder: (context, params) => SmallDeliveryScreenWidget(
                favCoordinates: params.getParam<LatLng>(
                  'favCoordinates',
                  ParamType.LatLng,
                  isList: true,
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/eFS7qKfR49by_1242_2688_(1).png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
