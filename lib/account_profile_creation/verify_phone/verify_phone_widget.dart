...
class VerifyPhoneWidget extends StatefulWidget {
  ...
  static String routeName = 'VerifyPhone';
  static String routePath = 'verifyPhone';
                                  ...
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text:
                                            FFLocalizations.of(context).getText(
                                          'z42xogdp' /* Enter the 6 digit code that yo... */,
                                        ),
                                        style: TextStyle(),
                                      ),
                                      TextSpan(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'bqpmrgpl' /* Resend will be available in: */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
