...
class _PaymentScreenWidgetState extends State<PaymentScreenWidget>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PaymentMethodsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PaymentMethodsRecord> paymentScreenPaymentMethodsRecordList =
            snapshot.data!;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(26.0, 10.0, 0.0, 0.0),
                      child: RichText(
                  ...
                  Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final cards =
                            paymentScreenPaymentMethodsRecordList.toList();
                        if (cards.isEmpty) {
                          return Center(
                            child: EmptyWidget(
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            valueOrDefault<String>(
                                              'Expiry Date ${cardsItem.expiryDate.toString()}',
                                              'n/a',
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
