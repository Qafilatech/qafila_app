    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(0.0, 150.0, 0.0, 70.0),
              child: Container(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  valueOrDefault<String>(
                                                    '**** **** **** ${valueOrDefault<String>(
                                                      (int.parse(listViewPaymentMethodsRecord
                                                                  .cardNumber) %
                                                              10000)
                                                          .toString(),
                                                      '0',
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(
                                                valueOrDefault<String>(
                                                  'Expiry Date ${listViewPaymentMethodsRecord.expiryDate}',
                                                  'n/a',
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
