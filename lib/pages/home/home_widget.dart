    ...
    return GestureDetector(
      ...
      child: Scaffold(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(16.0, 70.0, 16.0, 12.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        ClipRRect(
                            ...
                            child: AnimatedContainer(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      FavouritesScreenWidget.routeName,
                                      extra: <String, dynamic>{
                                        kTransitionInfoKey: TransitionInfo(
                                          hasTransition: true,
                                          transitionType:
        ...
        endDrawer: Drawer(
          elevation: 16.0,
          child: Padding(
            padding: EdgeInsetsDirectional.fromSTEB(0.0, 86.0, 0.0, 0.0),
            child: Column(
              mainAxisSize: MainAxisSize.max,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
          ...
          child: Column(
            ...
            children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          _model.detectedOS = await actions.detectOS();
                ...
                child: StreamBuilder<List<OrdersRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (rowOrdersRecordList.isEmpty) {
                      return EmptyWidget(
                        title: 'No Order Created',
                        desc:
                            'Start your order by selecting one of th eoptions.',
                        icon: FaIcon(
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: List.generate(rowOrdersRecordList.length,
                            (rowIndex) {
                          final rowOrdersRecord = rowOrdersRecordList[rowIndex];
                          return Visibility(
                            visible: rowOrdersRecord.orderId != '',
                            child: Align(
                              alignment: AlignmentDirectional(-1.0, 0.0),
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                          ...
                          filterFn: (rowIndex) {
                            ...
                            return rowOrdersRecord.orderId != '';
                          },
                        ),
                      ),
                    );
              ...
              Padding(
                ...
                child: StreamBuilder<List<FavoriteLocationsRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<FavoriteLocationsRecord>
                        rowFavoriteLocationsRecordList = snapshot.data!;
                    if (rowFavoriteLocationsRecordList.isEmpty) {
                      return Center(
                        child: EmptyWidget(
                          title: 'No Favorite Location Set',
                          desc: 'You can favorite a location when ordering.',
                          icon: Icon(
                            Icons.favorite,
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Row(
                        ...
                        children: List.generate(
                            rowFavoriteLocationsRecordList.length, (rowIndex) {
                          final rowFavoriteLocationsRecord =
                              rowFavoriteLocationsRecordList[rowIndex];
                          return Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 6.0, 0.0),
                            child: InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  LargeDeliveryScreenWidget.routeName,
                                  queryParameters: {
                                    'favCoordinates': serializeParam(
                                      rowFavoriteLocationsRecord
                                          .locationCoordinates,
                                      ParamType.LatLng,
                                      isList: true,
                                    ),
                                    'favAddress': serializeParam(
                                      rowFavoriteLocationsRecord
                                          .locationAddresses,
                                      ParamType.String,
                                      isList: true,
                              ...
                              child: wrapWithModel(
                                model: _model.favouritesModels.getModel(
                                  rowFavoriteLocationsRecord.reference.id,
                                  rowIndex,
                                ),
                                ...
                                child: FavouritesWidget(
                                  key: Key(
                                    'Keybfk_${rowFavoriteLocationsRecord.reference.id}',
                                  ),
                                  locations: rowFavoriteLocationsRecord
                                      .locationCoordinates,
                                  fevRef: rowFavoriteLocationsRecord.reference,
                                  orderType:
                                      rowFavoriteLocationsRecord.locationType,
                                  title:
                                      rowFavoriteLocationsRecord.locationName,
                                  numberOfLoc: rowFavoriteLocationsRecord
                                      .locationDropCount,
                                  locationAddresses: rowFavoriteLocationsRecord
                                      .locationAddresses,
                                ),
                              ),
                            ),
