...
import 'small_delivery_screen_model.dart';
export 'small_delivery_screen_model.dart';

class SmallDeliveryScreenWidget extends StatefulWidget {
  const SmallDeliveryScreenWidget({
    super.key,
    this.favCoordinates,
    this.favAddress,
    bool? favStatus,
  ...
  static String routeName = 'SmallDeliveryScreen';
  static String routePath = 'smallDeliveryScreen';

  @override
  State<SmallDeliveryScreenWidget> createState() =>
      _SmallDeliveryScreenWidgetState();
}

class _SmallDeliveryScreenWidgetState extends State<SmallDeliveryScreenWidget>
    with TickerProviderStateMixin {
  late SmallDeliveryScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SmallDeliveryScreenModel());
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: FlutterFlowPlacePicker(
                                      iOSGoogleMapsApiKey:
                                          'AIzaSyBd-QNrKLT_VWUbyXRvUNKQnExJrAM9Dtk',
                                      androidGoogleMapsApiKey:
                                          'AIzaSyDAEAbHKxyho9-K0MPATyG76VjCRdX5BR0',
                                      webGoogleMapsApiKey:
                                          'AIzaSyD59lDYEREVHxOmkgCIOBBomQqvmVWOKfI',
                                        ...
                                        if (isAndroid) {
                                          ...
                                          if ((_model
                                            ...
                                            _model.addToLocListAddy(
                                              ...
                                              _model.locListAddy.firstOrNull,
                                              '0',
                                            ));
                                            safeSetState(() {});
                                          } else {
                                          ...
                                          if (isiOS) {
                                            ...
                                            if (isWeb) {
                                              _model.apiResultzqa2 =
                                                  await GeocodingWEBCall.call();

                                              _shouldSetState = true;
                                              if ((_model.apiResultzqa2
                                                      ?.succeeded ??
                                                  true)) {
                                                _model.addToLocList(
                                                    _model.googleMapsCenter!);
                                              ...
                                              _model.apiResultzqa4 =
                                                  await GeocodingWEBCall.call();

                                              _shouldSetState = true;
                                              if ((_model.apiResultzqa4
                                                      ?.succeeded ??
                                                  true)) {
                                                _model.addToLocList(
                                                    _model.googleMapsCenter!);
                                                ...
                                                builder: (context) {
                                                  ...
                                                  if (locationList.isEmpty) {
                                                    return EmptyWidget(
                                                      ...
                                                      desc:
                                                          'Start by adding a pin to your location',
                                                      icon: Icon(
                                                        Icons.checklist_rtl,
                                                        size: 32.0,
                                                      ),
                                                        ...
                                                        endActionPane:
                                                          ...
                                                          children: [
                                                            SlidableAction(
                                                              ...
                                                              onPressed:
                                                                  (_) async {
                                                                _model.removeAtIndexFromLocList(
                                                                    locationListIndex);
                                                                _model.removeAtIndexFromLocListAddy(
                                                                    locationListIndex);
                                                                safeSetState(
                                                                    () {});
                                                              },
                                          ...
                                          children: [
                                            Align(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'bo0s07xi' /* What type of vehicle do you ne... */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                          ...
                                          children: [
                                            Align(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'xgiwewr4' /* What type of cargo will you be... */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                          ...
                                          children: [
                                            Align(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'oi4zf4db' /* Handeling Instructions */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                      ...
                                      Padding(
                                        ...
                                        child: FlutterFlowChoiceChips(
                                          options: [
                                            ...
                                            ChipData(FFLocalizations.of(context)
                                                .getText(
                                              'kcbh2vfr' /* Oversize/Heavy */,
                                            )),
                                            ChipData(FFLocalizations.of(context)
                                                .getText(
                                              'wg7wn0cc' /* Keep Upright/ Do Not Tilt */,
                                            )),
                                            ChipData(FFLocalizations.of(context)
                                                .getText(
                                              'g6ngghl6' /* Do Not Stack */,
                                            )),
                                            ChipData(FFLocalizations.of(context)
                                                .getText(
                                              '5glxqtwu' /* Keep Dry */,
                                          ...
                                          children: [
                                            Align(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  '8py7cwwp' /* How many helpers do you need? */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                          ...
                                          children: [
                                            Align(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'nmkhatcy' /* Upload a picture of your cargo */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              if (_model
                                                  .uploadedFileUrls_uploadData79o1
                                                  .isNotEmpty)
                                                Container(
                                                  width: 80.0,
                                                  height: 80.0,
                                                      ...
                                                      if (selectedUploadedFiles
                                                          ...
                                                          downloadUrls.length ==
                                                              selectedMedia
                                                                  .length) {
                                                        safeSetState(() {
                                                          _model.uploadedLocalFiles_uploadData79o1 =
                                                              selectedUploadedFiles;
                                                          _model.uploadedFileUrls_uploadData79o1 =
                                                              downloadUrls;
                                                        });
                                                        showUploadMessage(
                                                            context,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '1oaouj8z' /* Please choose one of the payme... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'fs9sgajp' /* Or use an option below */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'qs777ccf' /* Handling Instructions - */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'ix8drka8' /* Additional Information */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                                        .override(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Align(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'kelp64t4' /* Who will be receiving the pack... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                ...
                                if (!_model.switchReceivingPartyValue!)
                                  Padding(
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        final contactList = _model.locListAddy
                                            .toList()
                                            .take(4)
                                            .toList();
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Align(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '6w9ajb8x' /* Add a message for the delivery */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'kb7tj5ei' /* Please fill in any information... */,
                                        ),
                                      ...
                                      if (_model.payment == true) {
                                        ...
                                        await ordersRecordReference.set({
                                          ...createOrdersRecordData(
                                            ...
                                            paymentAmount: functions.priceCalcu(
                                                0.285,
                                                _model
                                                    .countControllerAssistValue!,
                                                valueOrDefault<String>(
