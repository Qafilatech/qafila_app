...
import '/index.dart';
import 'small_delivery_screen_widget.dart' show SmallDeliveryScreenWidget;
import 'package:flutter/material.dart';

class SmallDeliveryScreenModel
    extends FlutterFlowModel<SmallDeliveryScreenWidget> {
  ...
  List<FFUploadedFile> uploadedLocalFiles_uploadData79o1 = [];
  List<String> uploadedFileUrls_uploadData79o1 = [];
